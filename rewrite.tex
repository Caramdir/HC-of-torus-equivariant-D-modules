...
\begin{Lem}\label{lem:contractive}
    Assume that $\stack X$ has a trivial contractive $\Gm$-action and that both $\stack X_0$ and $\stack U = \stack X\setminus \stack X_0$ have property \bc\ (respectively property \hbc).
