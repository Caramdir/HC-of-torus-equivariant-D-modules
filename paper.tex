...
\renewcommand\B{\stack{B}}                  % classifying stack
\newcommand\LocSys{\operatorname{LocSys}}   % local systems
\newcommand\Bun{\operatorname{Bun}}         % bundles
%\newcommand\mappingstack{\mathbfup{Maps}}   % mapping stack
...
\newcommand\catDModHol[1]{\catDMod[\mathup{hol}]{#1}}   % holonomic D-modules
